...
p_s_o1neuro = {'architecture': [ [0, 8, 4, 1],
                                ...
                                [0, 16, 8, 4, 1],
                                [0, 4, 4, 4, 4, 1]],
               'stabilizer' : [0.5, 0.1, 0.01, 0]} 


space_o1neuro = {
    'eta': hp.uniform('eta', 0.05, 0.9), 
    'M': hp.quniform('M', 3, 50, 1),
    'b': hp.quniform('b', 19, 20, 1), # 30
    'stabilizer': hp.choice('stabilizer', p_s_o1neuro['stabilizer']),
...
def objective_o1neuro_regression(space):
    ...
    model = o1NeuroBoost(list(space['architecture'][1:]), 
                       eta = space['eta'], 
                       M = int(space['M']),
                       K = 10, 
                       sparsity_level=2,
    ...
    model.train_reboost(X_train_in, 
                        y_train_in, 
                        b = int(space['b']))
    model.train_bagging(b = 1, n_estimators=10)
